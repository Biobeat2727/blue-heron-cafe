import { cafeAddress } from './eventSchema';
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "486260 US-95, Sandpoint, ID 83864 — in Samuels, north of Sandpoint."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sunday–Monday 6am–2pm, Tuesday–Thursday 6am–7pm, Friday–Saturday 6am–8pm."
      }
    },
    {
      "@type": "Question",
...
export const generateHighlightArticleSchema = ({ title, description, imageUrl, publishedAt, url }) => ({
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": title,
  ...
  "publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://blueheronsamuels.com/images/blue-heron-vertical-logo.png"
    }
  },
  "mainEntityOfPage": {
    "@type": "WebPage",
